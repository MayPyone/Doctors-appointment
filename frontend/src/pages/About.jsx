  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row gap-12'>
        <img className='w-full md:max-w-[360px]' src={assets.about_image} alt='doctor image'/>
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>Prescripto is committed to excellence in healthcare technology.
             ...
             to improve user experience and deliver superior service. Whether you're booking your 
      ...
      <div className='text-xl my-4'>
        <p className='my-10'>Why <span className='text-gray-700 font-semibold'>Choose Us</span></p>
